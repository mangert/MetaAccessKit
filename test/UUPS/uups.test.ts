...
import { IETHAccount, AccountBoxV1 } from "../../typechain-types";
...
describe("UUPS-upgradable tests", function() {
    ...
    describe("deployment tеsts", function() { //примитивный тест на деплой - просто проверить, что общая часть работает
        it("should be deployed", async function() {
            ...
            console.log('UUPS proxy addr: ', await proxyBox.getAddress());
            const implAddress = await upgrades.erc1967.getImplementationAddress(await proxyBox.getAddress());
